...
class _ServiceLocatorScreenState extends State<ServiceLocatorScreen> {
  ...
  Future<void> _loadServices() async {
    ...
    try {
      final serviceLocator = Provider.of<ServiceLocatorService>(context, listen: false);
      ...
      if (_currentPosition != null) {
        ...
        _services = allServices.map((s) => ServiceWithDistance(service: s, distance: 0)).toList();
      }
              ...
              if (service.youthFriendly) ...[
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Icon(Icons.verified, size: 14, color: AppConstants.successColor),
                      SizedBox(width: 4),
                      Text(
                        'Youth Friendly',
                        style: TextStyle(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              _buildDetailRow(Icons.location_on, 'Address', '${service.address}, ${service.county}'),
              _buildDetailRow(Icons.phone, 'Phone', service.phoneNumber),
              _buildDetailRow(Icons.access_time, 'Hours', service.operatingHours),
              
              if (_currentPosition != null)
                _buildDetailRow(Icons.directions, 'Distance', serviceWithDistance.distanceFormatted),
              ...
              if (service.servicesOffered.isNotEmpty) ...[
                ...
                ...service.servicesOffered.map((s) => Padding(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.check, size: 16, color: AppConstants.successColor),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () => _openMaps(service.latitude, service.longitude),
