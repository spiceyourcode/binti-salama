...
class AppConstants {
  ...
  static const double shakeThreshold = 50.0; // High threshold for time-normalized acceleration
  static const double shakeDeltaThreshold = 15.0; // Minimum magnitude change to count as shake
